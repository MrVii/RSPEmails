			...
			<tr>
				<td class="email_body email_start email_end tc">
					...
					<table role="presentation" class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody>
							<tr>
								<td class="content_cell hero_b pb brt tc" background="<?php echo $default_background; ?>">
												...
												<td class="column_cell sc logo_c pt tc">
													<?php
														if ( $img = get_option( 'woocommerce_email_header_image' ) ) {
															echo '<a href="' . get_home_url() . '" class="sc"><img src="' . esc_url( $img ) . '" width="'. $logo_width .'" height="" alt="' . get_bloginfo( 'name', 'display' ) . '" style="max-width:'. $logo_width .'px;" /></p>';
														}
														else {
