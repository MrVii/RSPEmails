												...
												<td class="column_cell logo_c sc pt tc">
													<?php
														if ( $img = get_option( 'woocommerce_email_header_image' ) ) {
															...
															echo '<h2 class="mt_0 mb_0 sc"><a href="' . get_home_url() . '" class="sc"><span class="sc">' . get_bloginfo( 'name', 'display' ) . '</span></a></h2>';
														}
													?>
												</td>
											</tr>
							...
							<tr>
								<td class="content_cell content_b tc">
									<table role="presentation" class="column" width="100%" border="0" cellspacing="0" cellpadding="0">
										<tbody>
											<tr>
												<td class="column_cell pte tc">
													<table role="presentation" class="ic_h" align="center" width="80" border="0" cellspacing="0" cellpadding="0">
														<tbody>
															<tr>
																<td class="accent_b">
																	<p class="imgr mb_0"><img role="img" src="<?php echo $theme_path; ?>/shopping-cart_white.png" width="48" height="48" alt="Shopping cart symbol" style="max-width:48px;" /></p>
																</td>
															</tr>
														</tbody>
													</table>
													<h1 class="mb_0"><?php echo $email_heading; ?></h1>
												</td>
											</tr>
										</tbody>
									</table>
