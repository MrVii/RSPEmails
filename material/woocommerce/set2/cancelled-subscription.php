					...
					<tbody>
						<tr>
							<td class="column_cell tl switch_tc">
								...
								<?php endif; ?>
								<p class="mb_xs"><strong><?php echo esc_html_x( 'End of Prepaid Term', 'table headings in notification email', 'woocommerce-subscriptions' ); ?>:</strong> <?php echo esc_html( date_i18n( wc_date_format(), $subscription->get_time( 'end', 'site' ) ) ); ?></p>
							</td>
						</tr>
					</tbody>
				</table>
